<x-forum.layouts.app>
    <div class="max-w-3xl mx-auto my-8">
        <h1 class="text-2xl font-bold mb-6">Editar pregunta</h1>
        ...
        <form action="{{ route('questions.update', $question) }}" method="POST" class="space-y-6">
            ...
            <div>
                ...
                <textarea name="content" rows="8" required
                          class="w-full border rounded-md px-3 py-2 text-sm bg-white text-gray-900">{{ old('content', $question->content) }}</textarea>
            ...
            <div class="flex items-center gap-3">
                ...
                <a href="{{ route('question.show', $question) }}" class="text-sm hover:underline">Cancelar</a>
            </div>
        </form>
    </div>
</x-forum.layouts.app>
